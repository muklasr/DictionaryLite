...
import com.adwitya.simpledictionary.ui.word.MyEngIdnFragment
import com.adwitya.simpledictionary.ui.word.MyIdnEngFragment

class MyWordPagerAdapter (private val mContext: Context, fm: FragmentManager) :
    ...
    override fun getItem(position: Int): Fragment {
        ...
        when (position) { //get fragment by position
            0 -> fragment = MyIdnEngFragment()
            1 -> fragment = MyEngIdnFragment()
        }
